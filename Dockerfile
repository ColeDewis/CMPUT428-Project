...
RUN echo "alias cameras_start='python3 ./scripts/cam_test.py && tmux attach'" >> ~/.bashrc
RUN echo "alias robot_start='python3 ./scripts/robot_start.py && tmux attach'" >> ~/.bashrc
