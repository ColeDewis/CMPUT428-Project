...
if __name__ == "__main__":
    ...
    angles = np.array([-0.19655300635664474, 0.8299573758083271, -2.8110765191316562, -1.0309490727538062, -0.31231795578129784, -1.1241426666756027, 1.7763640002834045])   
    print("BEFORE: ", rospy.get_rostime())
    success = gen3.send_joint_angles(angles)
    print("AFTER: ", rospy.get_rostime())
    gen3.send_gripper_command(0.99)
